classdef QuadCopterConnection < handle
    ...
    methods
        function obj = QuadCopterConnection(varargin)
            obj.dataListener = EventListener(varargin{:},@obj.processGPSString);
        end
        
        function processGPSString(obj,raw)
            processedData = QuadCopterConnection.parseGPSString(raw);
