...
%% Initiate user specified workflow
    newDemoMission    = 'Demonstrate the mission kinematics and dynamics';
    newDemoMissionK   = 'Demonstrate the mission kinematics';
    newRunMission     = 'Run and setup the mission yourself';
    
        workflow = questdlg( 'Make sure to first run two other apps in separate MATLAB sessions: (1) SERS server, and (2) SERS requests. Please choose the mode of the rescue mission.','Mission workflow',...
