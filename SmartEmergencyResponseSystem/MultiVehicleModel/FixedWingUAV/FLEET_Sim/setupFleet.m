...
% Number of aircraft
AC_Fleet.nAC= 2; 
AC_Fleet.IC.InertialPos = [0 0 ; 0 0; -100 -100 ]; 
AC_Fleet.IC.Pos_Heading = [0 0; 0 0 ; -100 -100; 0 pi/2 ]; 
%AC_Fleet.IC.Pos_Heading = [0; 0; -100; 0 ]; 

AC_Fleet.nOutUAVFleet = ones(1,AC_Fleet.nAC)*5 ;
%AC_Fleet.nOutUAVFleet = 4*AC_Fleet.nAC;



%% Simulation sample time
simPars.SampleTime = 0.02; % sec
simPars.Tf = 400; %(sec)
