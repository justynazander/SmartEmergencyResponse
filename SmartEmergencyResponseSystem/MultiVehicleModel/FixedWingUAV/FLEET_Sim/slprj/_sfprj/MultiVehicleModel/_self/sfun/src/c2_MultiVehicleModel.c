...
static void initialize_c2_MultiVehicleModel(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance);
static void initialize_params_c2_MultiVehicleModel
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance);
static void enable_c2_MultiVehicleModel(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance);
static void disable_c2_MultiVehicleModel(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance);
static void c2_update_debugger_state_c2_MultiVehicleModel
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_MultiVehicleModel
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance);
static void set_sim_state_c2_MultiVehicleModel
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance, const mxArray *c2_st);
static void finalize_c2_MultiVehicleModel(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance);
static void sf_c2_MultiVehicleModel(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance);
static void initSimStructsc2_MultiVehicleModel
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance);
static void init_script_number_translation(uint32_T c2_machineNumber, uint32_T
  c2_chartNumber);
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData);
static void c2_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_b_waypointsFleet, const char_T
  *c2_identifier, real_T c2_y[600]);
static void c2_b_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
...
static const mxArray *c2_b_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_c_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_fcnFleet, const char_T *c2_identifier,
  real_T c2_y[2]);
static void c2_d_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[2]);
...
static const mxArray *c2_c_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static void c2_e_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_dataFleet, const char_T *c2_identifier,
  real_T c2_y[600]);
static void c2_f_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId,
  real_T c2_y[600]);
...
static const mxArray *c2_f_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static real_T c2_g_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
...
static const mxArray *c2_g_sf_marshallOut(void *chartInstanceVoid, void
  *c2_inData);
static int32_T c2_h_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void c2_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c2_mxArrayInData, const char_T *c2_varName, void *c2_outData);
static uint8_T c2_i_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_b_is_active_c2_MultiVehicleModel, const
  char_T *c2_identifier);
static uint8_T c2_j_emlrt_marshallIn(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance, const mxArray *c2_u, const emlrtMsgIdentifier *c2_parentId);
static void init_dsm_address_info(SFc2_MultiVehicleModelInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_MultiVehicleModel = 0U;
}
  ...
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance)
{
  ...
  c2_hoistedGlobal = chartInstance->c2_is_active_c2_MultiVehicleModel;
  ...
  (SFc2_MultiVehicleModelInstanceStruct *chartInstance, const mxArray *c2_st)
{
  ...
  chartInstance->c2_is_active_c2_MultiVehicleModel = c2_i_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c2_u, 3)),
     "is_active_c2_MultiVehicleModel");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_MultiVehicleModel(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_MultiVehicleModelInstanceStruct *chartInstance;
  chartInstance = (SFc2_MultiVehicleModelInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c2_MultiVehicleModel_get_eml_resolved_functions_info(void)
{
  ...
  char_T *c2_identifier)
{
  ...
  c2_y = c2_j_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_MultiVehicleModel), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_MultiVehicleModel);
  return c2_y;
}
...
void sf_c2_MultiVehicleModel_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c2_MultiVehicleModel_get_autoinheritance_info(void)
{
...
mxArray *sf_c2_MultiVehicleModel_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c2_MultiVehicleModel_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c2_MultiVehicleModel(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[5],T\"dataFleet\",},{M[1],M[9],T\"fcnFleet\",},{M[4],M[0],T\"waypointsFleet\",S'l','i','p'{{M1x2[189 203],M[0],}}},{M[8],M[0],T\"is_active_c2_MultiVehicleModel\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_MultiVehicleModel_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc2_MultiVehicleModelInstanceStruct *chartInstance;
    chartInstance = (SFc2_MultiVehicleModelInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c2_MultiVehicleModel(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar);
  initialize_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c2_MultiVehicleModel(void *chartInstanceVar)
{
  enable_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c2_MultiVehicleModel(void *chartInstanceVar)
{
  disable_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c2_MultiVehicleModel(void *chartInstanceVar)
{
  sf_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c2_MultiVehicleModel(SimStruct*
  S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c2_MultiVehicleModel
    ((SFc2_MultiVehicleModelInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c2_MultiVehicleModel();/* state var info */
...
extern void sf_internal_set_sim_state_c2_MultiVehicleModel(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c2_MultiVehicleModel(SimStruct* S)
{
  return sf_internal_get_sim_state_c2_MultiVehicleModel(S);
}

static void sf_opaque_set_sim_state_c2_MultiVehicleModel(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c2_MultiVehicleModel(S, st);
}

static void sf_opaque_terminate_c2_MultiVehicleModel(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_MultiVehicleModelInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_MultiVehicleModel_optimization_info();
    }

    finalize_c2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc2_MultiVehicleModel((SFc2_MultiVehicleModelInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_MultiVehicleModel(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_MultiVehicleModel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c2_MultiVehicleModel(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_MultiVehicleModel(SimStruct *S)
{
  SFc2_MultiVehicleModelInstanceStruct *chartInstance;
  chartInstance = (SFc2_MultiVehicleModelInstanceStruct *)utMalloc(sizeof
    (SFc2_MultiVehicleModelInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc2_MultiVehicleModelInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_MultiVehicleModel;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_MultiVehicleModel;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_MultiVehicleModel;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c2_MultiVehicleModel;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c2_MultiVehicleModel;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_MultiVehicleModel;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_MultiVehicleModel;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_MultiVehicleModel;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c2_MultiVehicleModel;
  chartInstance->chartInfo.mdlStart = mdlStart_c2_MultiVehicleModel;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_MultiVehicleModel;
...
void c2_MultiVehicleModel_method_dispatcher(SimStruct *S, int_T method, void
  *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_MultiVehicleModel(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_MultiVehicleModel(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_MultiVehicleModel(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_MultiVehicleModel_method_dispatcher.\n"
